...
Цей репозиторій є **джерелом істини**. Спрямуйте будь-якого AI-агента (Claude Code, Codex, Gemini, Cursor, Windsurf, Lovable, Kiro, ...) на цю теку, і він матиме все потрібне, щоб відтворити налаштування на новій машині.
