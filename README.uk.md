...
Відтворювана конфігурація для [mcp-memory-service](https://github.com/doobidoo/mcp-memory-service) на машинах з macOS та Linux, плюс власний скіл для Claude Code і хук пост-сесійної дистиляції, які його обгортають.

Цей репозиторій є **джерелом істини**. Спрямуйте будь-якого AI-агента (Claude Code, Codex, Gemini, Cursor, Kiro, ...) на цю теку, і він матиме все потрібне, щоб відтворити налаштування на новій машині.
...
├── skills/
│   └── mcp-memory-query/
│       └── SKILL.md                  # вміст скіла / системного промпта
└── scripts/
